...
bot = Client(
    "bot",
    api_id= 26920567,
    api_hash= "3a41f605ab36dca9370532f79692693a"
    bot_token=6760138351:AAHbLFtm5T34WYF4RA3ibPba_NTqghV8qTM)
...
async def account_login(bot: Client, m: Message):
    ...
    await editable.edit("Now send the Thumb url/nEg » https://graph.org/file/db1505db1cedbc13ad084.jpg \n Or if don't want thumbnail send = no")
